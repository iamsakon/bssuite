...
public class ConfirmBehavior extends AbstractBehavior {
	...
	public final static String BEHAVIOR_ID = "swn.ConfirmBehavior";
	...
	public String getScript(ClientBehaviorContext behaviorContext) {
		...
		if (component instanceof Confirmable) {
			String script = "PrimeFaces.confirm({source:\"" + source
					+ "\",header:" + headerText + ",message:" + messageText
					+ ",icon:\"" + getIcon() + "\"});return false;";
			...
			throw new FacesException(
					"Component "
							+ source
							+ " is not a Confirmable. ConfirmBehavior can only be "
